...
import com.example.android.reportcard.dialog.AboutSecondStudent;
import com.example.android.reportcard.dialog.AboutThirdStudent;
import com.example.android.reportcard.model.Subject;

import java.util.ArrayList;

public class ThirdStudentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new Subject(getString(R.string.serbian), R.drawable.serbian,getString(R.string.whiteColor),5));
        list.add(new Subject(getString(R.string.physics), R.drawable.physics,getString(R.string.physicsColor),4));
        ...
        list.add(new Subject(getString(R.string.german), R.drawable.german,getString(R.string.whiteColor),5));
        list.add(new Subject(getString(R.string.geography), R.drawable.geographyone,getString(R.string.geographyColor),4));
        ...
        list.add(new Subject(getString(R.string.art), R.drawable.arttwo,getString(R.string.artColor),5));
        list.add(new Subject(getString(R.string.musics), R.drawable.music,getString(R.string.musicsColor),5));
        ...
        myFab.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                AlertDialog alertDialog = new AboutThirdStudent(ThirdStudentActivity.this).prepareDialog();
                alertDialog.show();
