...
public class SecondStudentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new Subject(getString(R.string.physics), R.drawable.physics,getString(R.string.physicsColor),3));
        ...
        list.add(new Subject(getString(R.string.chemistry), R.drawable.chemistryone,getString(R.string.chemistryColor),3));
        ...
        list.add(new Subject(getString(R.string.musics), R.drawable.music,getString(R.string.musicsColor),3));
        ...
        myFab.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                AlertDialog alertDialog = new AboutSecondStudent(SecondStudentActivity.this).prepareDialog();
                alertDialog.show();
