...
import com.example.android.reportcard.dialog.AboutFourthStudent;
import com.example.android.reportcard.dialog.AboutSecondStudent;
import com.example.android.reportcard.model.Subject;

import java.util.ArrayList;

public class FourthStudentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new Subject(getString(R.string.biology), R.drawable.biology,getString(R.string.biologyColor),5));
        ...
        myFab.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                AlertDialog alertDialog = new AboutFourthStudent(FourthStudentActivity.this).prepareDialog();
                alertDialog.show();
                alertDialog.getWindow().setBackgroundDrawableResource(R.color.lightColor);
            }
        });
    }
