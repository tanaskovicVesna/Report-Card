...
public class AboutFirstStudent extends AlertDialog.Builder {



    public AboutFirstStudent( Context context) {
        super(context);
        Student student = new Student(getContext().getString(R.string.pupilfirst));
        ArrayList<Subject>  subjects = new ArrayList<Subject>();

        subjects.add(new Subject(getContext().getString(R.string.mathematics),5));
        subjects.add(new Subject(getContext().getString(R.string.serbian),4));
        ...
        subjects.add(new Subject(getContext().getString(R.string.german),4));
        subjects.add(new Subject(getContext().getString(R.string.geography),4));
        ...
        subjects.add(new Subject(getContext().getString(R.string.art),4));
        subjects.add(new Subject(getContext().getString(R.string.musics),2));
