...
public class AboutSecondStudent extends AlertDialog.Builder {
    public AboutSecondStudent( Context context) {
        super(context);
        Student student = new Student(getContext().getString(R.string.pupilsecond));
        ...
        subjects.add(new Subject(getContext().getString(R.string.physics),3));
        subjects.add(new Subject(getContext().getString(R.string.religious),4));
        ...
        subjects.add(new Subject(getContext().getString(R.string.chemistry),3));
        ...
        subjects.add(new Subject(getContext().getString(R.string.musics),3));
