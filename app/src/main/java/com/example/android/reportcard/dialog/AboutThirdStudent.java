...
public class AboutThirdStudent extends AlertDialog.Builder {
    public AboutThirdStudent( Context context) {
        super(context);

        Student student = new Student(getContext().getString(R.string.pupilthird));
        ...
        subjects.add(new Subject(getContext().getString(R.string.physics),4));
        subjects.add(new Subject(getContext().getString(R.string.religious),5));
        subjects.add(new Subject(getContext().getString(R.string.biology),4));
